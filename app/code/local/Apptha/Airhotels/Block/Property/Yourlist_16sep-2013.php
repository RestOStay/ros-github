...
class Apptha_Airhotels_Block_Property_Yourlist extends Mage_Catalog_Block_Product_Abstract
{
    ...
    public function getAdvanceSearchResult(){
        ...
        $data = array("address"=>$address,"checkin"=>$checkin,"checkout"=>$checkout,"searchguest"=>$searchguest,"amount"=>$amount,"pageno"=>$pageno,"roomtypeval"=>$roomtypeVal,"amenityVal"=>$amenityval,"upperLimitPrice"=>$upperLimitPrice,"order"=>$Order);
