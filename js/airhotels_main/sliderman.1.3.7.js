...
var Sliderman = new function(){
	...
	Sliderman.slider = function(parameters){
		...
		var Slider = {}, current = null, previous = null, EffectN = 0, nextIndex = null, prevImg, status = 'free', isHover = true, images = [], descriptions = [], links = [], ef = function(){};
		...
		//CONTAINERS
		var sliderCont = newElement('DIV', {width: display.width, height: display.height,background:'#000', margin: '0 auto', position: 'relative'}); mainCont.appendChild(sliderCont);
		...
		if(description && !contentmode){
			...
			descriptionStl[description.position == 'bottom'?'bottom':'top'] = 37;
