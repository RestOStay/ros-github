...
class Apptha_Airhotels_Helper_Data extends Mage_Core_Helper_Abstract
{
	...
	{
		return $this->_getUrl('restostay/property/form');
	}
        /**
	 * Retrieve calendar
	 *
	 ...
	 */
        public function getblockurl(){
          ...
          return $this->_getUrl('restostay/property/blockdate');
        }
	...
	{
		return $this->_getUrl('restostay/property/show') ;
	...
	{
		return $this->_getUrl('restostay/property/yourtrip') ;
	...
	{
		return $this->_getUrl('restostay/property/edit') ;
	...
	{
		return $this->_getUrl('restostay/property/image');
	...
	{
		return $this->_getUrl('restostay/property/calender') ;
	...
	public function getRDAdapter()
	{
     ...
     {
         return $this->_getUrl('restostay/property/popular');
     }
     ...
     {
         return $this->_getUrl('restostay/property/wishlist');
     }
}
